...
selectLayerByIndex(currLayerIndex);
 ...
 /*
     - Export the non-retina version of the asset into a sub-folder called "ios-regular" (ios-regular/image.png)
- Also export the retina version of the asset into a sub-folder called "ios-retina" (ios-regular/image@2x.png)
*/
        //regular
        var currFolder = Folder(targetFolder+"/ios-regular").createOnce();
       ...
       //retina
        app.activeDocument.resizeImage(app.activeDocument.width,app.activeDocument.height,app.activeDocument.resolution*2);
       currFolder = Folder(targetFolder+"/ios-retina").createOnce();
       currFile = File(currFolder+"/"+assetName+"@2x.png");
